...
This project cleans a raw ~5.5 million-row government trade dataset, engineers commodity and time-based features, and derives business-relevant insights on trade seasonality, top trading partners, and sector-level pricing behavior — built entirely in Python on Google Colab using Pandas, NumPy, Matplotlib, and Seaborn.
...
- **Dataset link:** https://drive.google.com/file/d/1-3lyGE-mf-qFDa4eYVjJL1k-ittZKpBm/view?usp=sharing
...
|---|---|
| Track Trade & Export Trends	| Analyze how India's total export value to Asian countries changed month-by-month and year-by-year (2015–2025) to identify growth, decline, or stability |
| Identify Top Subregions by Revenue	| Determine which Asian subregions (Western, Eastern, South-eastern, Southern, Central) generate the highest export revenue, and quantify top-vs-bottom gaps |
| Evaluate Geographic Trade Share |	Identify the top 10 and bottom 10 trading partner countries by export value, and assess trade concentration vs. diversification |
| Uncover Monthly Seasonality	| Use a year-by-month heatmap to detect recurring peaks (e.g. financial year-end surges) and anomalies (e.g. pandemic-driven drops) |
| Compare Unit Value Realization |	Calculate price-per-unit realization across commodity categories to separate high-margin/low-volume sectors from high-volume/low-margin bulk sectors |
| Analyze Commodity Specialization	| Map which commodity categories dominate exports to each Asian subregion, revealing regional specialization patterns |
...
|---|---|---|
| Mean |	54,876.85 |	130.56 |
| Median	| 3.00	| 2.82 |
| Mode |	0.00 |	0.00 |
| Std. Dev |	3,926,595.81 |	3,051.99 |
| Variance	| ~15.4 trillion	 | ~9.3 million |
 ...
 **🗺️Commodity Specialization by Subregion**
